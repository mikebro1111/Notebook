...
print(dir(Nt))
print(dir(Nt.notes))
print(dir(Nt.new_note("Hello world")))
print(dir(Nt.__init__()))
print(isinstance(Nt, object))
print(isinstance(Nt.notes, object))
print(isinstance(Nt.new_note("Hello world"), object))
print(isinstance(Nt.__init__(), object))
